 ...
 * revision") - saves it as a new version over the existing row rather than
 * creating a duplicate. content_items has a unique (brief_id, content_type)
 * index specifically so this upsert is safe.
 */
